...
const App = () => {
  ...
  const getData = async () => {
    ...
    setIP(res.data.IPv4);
    localStorage.setItem("location", res.data.country_code);
  };
    ...
    <div className="App">
      ...
      <Switch>
        ...
        <Route
          exact
          path="/"
          render={() => <Redirect to="/apparel/rediva" />}
        />
        ...
        <Route
          path="/apparel/:filterStore?/:filterType?"
          render={() => (
            <MainLayout>
              {/* <Banner /> */}
              <Search cat="apparel" />
        ...
        <Route
          exact
          path="/living/:filterStore?/:filterType?"
          render={() => (
            <MainLayout>
              <Search cat="living" />
            </MainLayout>
        ...
        <Route
          ...
          render={() => (
            <MainLayout>
              <h1
                style={{ marginLeft: "40%", marginTop: "20px", color: "red" }}
              >
                payment Failed!
              </h1>
            </MainLayout>
