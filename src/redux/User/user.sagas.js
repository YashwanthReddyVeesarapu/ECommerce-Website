...
export function* signUpUser({ payload: {
  ...
  if (password !== confirmPassword) {
    const err = ['Passwords Didn\'t match'];
    yield put(
      userError({ signup: err })
    );
    return;
  }
      ...
      html: `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        <![endif]-->
          ...
          <title></title>
            ...
            <style type="text/css">
              table, td { color: #000000; } a { color: #ffffff; text-decoration: none; }
        ...
        * {
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #ffffff; line-height: 100%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 100%; text-align: center;"><span style="font-size: 40px; line-height: 40px;"><strong><span style="line-height: 40px; font-size: 40px;"><span style="line-height: 40px; font-size: 40px;">Hey ${displayName}, Account Created Successfully</span></span></strong></span></p>
          </div>
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%;">Inspiring collections on the way&gt;</p>
          </div>
        ...
        <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 48px; line-height: 67.2px;"><strong><span style="line-height: 67.2px; font-size: 48px;">Explore our Web</span></strong></span></p>
          </div>
        ...
        <div align="center">
          <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://rediva-lifestyle.web.app/" style="height:37px; v-text-anchor:middle; width:175px;" arcsize="11%" stroke="f" fillcolor="#eec60e"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
            <a href="https://rediva-lifestyle.web.app/" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #eec60e; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
              <span style="display:block;padding:10px 70px;line-height:120%;">Click</span>
            </a>
