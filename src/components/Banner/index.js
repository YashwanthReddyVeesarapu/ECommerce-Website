...
import { Button, MobileStepper, Paper, Typography, useTheme } from '@material-ui/core'
...
const Banner = () => {
    ...
    return (
        <div className='banner' >
            ...
            <img src={MyCollection[index].imgPath} style={{
                height: 233,
                width: "100%",
                objectFit: 'cover',
                display: "block",
            ...
            <MobileStepper
                ...
                index={index}
                steps={size}
                style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', transform: 'translateY(-100%)', position: 'absolute', width: '100%' }}
                backButton={
                    <Button
                        size="small"
