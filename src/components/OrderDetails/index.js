...
const OrderDetails = ({ order }) => {
  ...
  useEffect(() => {
    if (Array.isArray(orderItems) && orderItems.length === 0) setLoading(false);
    window.scrollTo(0, 0);
  }, [orderItems]);
  ...
  const handleChange = (e) => {
    const level = e;
    setStatus(e);
    dispatch(setOrderStatus(ID, level, order));
  };
  const abc = 1;
                  ...
                  >
                    ...
                    <Grid item xs align="left">
                      ...
                      {currentUser[0] === "admin" && auth == "admin" ? (
                        ...
                        >
                          <MenuItem key={0} value="Processing">
                            Processed
                          </MenuItem>
                          <MenuItem key={1} value="Dispatched">
                            Dispatched
                          </MenuItem>
                          <MenuItem key={2} value="Shipping">
                            Shipped
                          </MenuItem>
