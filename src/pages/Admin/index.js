...
const Admin = (props) => {
  ...
  function isMainAdmin() {
    if (ADMIN.includes(id)) return true;
    else return false;
  }
  ...
  return (
    <div className="admin">
      <SimpleDialog
        ...
        text={"You are not Yashwanth to delete Me! <br /> GET LOST !"}
      />
        ...
        <div className="addNewProductForm">
          <form>
            ...
            <FormInput
              ...
              value={brand}
              handleChange={(e) =>
                setProductBrand(e.target.value.toUpperCase())
              }
            />
            <FormInput
              label="Type"
            ...
            <FormInput
              ...
              value={productColor}
              handleChange={(e) =>
                setProductColor(e.target.value.toLowerCase().split(","))
              }
            />
            ...
            <div>
              ...
              {uploading ? (
                <CircularProgress
                  ...
                  color="inherit"
                />
              ) : typeof productThumbnail === "object" &&
                productThumbnail.length > 0 ? (
                productThumbnail.map((url, index) => {
                  return (
                    <div key={index} style={{ display: "inline" }}>
                      <img
                        style={{ padding: "2%", backgroundColor: "lightgray" }}
                        key={index}
                        width="30%"
                        src={url}
                      />
                      <input
                        onKeyDown={(e) =>
                          e.which === 191 && set(e.target.value, url)
                        }
                      />
                    </div>
                  );
                ...
                <h1 style={{ width: "30%", marginLeft: 0, color: "lightgray" }}>
              ...
              <textarea
                rows="10"
                cols="40"
                value={JSON.stringify(adaptiveThumbnails)}
              />
                      ...
                      data.map((product, index) => {
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              <Button
                                onClick={() => redirectToProduct(documentID)}
                              >
                                Edit
                              </Button>
                              <br />
