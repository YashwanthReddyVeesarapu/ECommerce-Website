        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm container>
            {cartItems.map((item, pos) => (
              ...
              >
                <Grid item>
                  {loadImage(item.productThumbnail).onload ? (
                    ...
                    <ButtonBase className={"image"}>
                      <img
                        ...
                        alt="thumbnail"
                        src={
                          Object.entries(item.adaptiveThumbnails.map)[
                            Object.keys(item.adaptiveThumbnails.map).indexOf(
                              item.colour
                            )
                          ][1]
                        }
